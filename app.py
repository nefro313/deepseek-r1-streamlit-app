...
st.caption("🚀 Your AI Pair Programmer with Debugging Superpowers and optimising your code")
...
prompt = """You are a Code Optimization Expert specializing in analyzing, explaining, and refining code. Follow this workflow:
